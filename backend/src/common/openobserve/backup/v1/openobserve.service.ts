...
export class OpenObserveService {
  ...
  constructor(private configService: ConfigService) {
    // 添加安全警告和弃用警告
    console.error(
      '[SECURITY WARNING] OpenObserveService contains critical security vulnerabilities (SQL injection, unsafe string interpolation). ' +
      'This service is deprecated and will be removed in a future version. ' +
      'IMMEDIATELY migrate to OpenObserveServiceV2 for better security and features. ' +
